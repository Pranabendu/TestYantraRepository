...
//		wait.until(ExpectedConditions.titleContains(""));
		...
		driver.findElement(By.xpath("//input[@placeholder='Enter Patient Name']")).sendKeys("Roy"+ju.getRandomNumber());
		...
		driver.findElement(By.xpath("//input[@placeholder='Enter Patient Email id']")).sendKeys("roy"+ju.getRandomNumber()+"@gmail.com");
		...
		driver.findElement(By.xpath("//textarea[@placeholder='Enter Patient Medical History(if any)']")).sendKeys("healthy");
		Thread.sleep(1500);
		...
		//view new added patient
				...
				//add Medical History
				WebElement addMedHistory = driver.findElement(By.xpath("//button[@class='btn btn-primary waves-effect waves-light w-lg']"));
				addMedHistory.click();
				Thread.sleep(2000);
